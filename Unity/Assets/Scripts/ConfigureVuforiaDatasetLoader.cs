...
namespace Rocket {
    ...
    public sealed class ConfigureVuforiaDatasetLoader : MonoBehaviour {
        ...
        private void Awake() {
            ...
            // This means the Vuforia data sets are actually bundled in the app twice by default
            // Instead, simply instruct Vuforia to look for the datasets in the Data dir, where they exist on disk
